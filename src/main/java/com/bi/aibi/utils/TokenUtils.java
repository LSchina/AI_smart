...
public class TokenUtils {
     ...
     * @return
     */
    public static String genToken(String adminId, String sign) throws UnsupportedEncodingException {
        return JWT.create().withAudience(adminId) // 将 user id 保存到 token 里面,作为载荷
                .withExpiresAt(DateUtil.offsetHour(new Date(), 5)) // 100小时后token过期
